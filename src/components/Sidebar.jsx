...
const navItems = [
  ...
  { path: '/analytics', label: 'Analytics', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
  ) },
  ...
  return (
    <div className="w-64 min-h-screen bg-white border-r border-gray-100 flex flex-col">
      <div className="p-6 flex items-center gap-3">
        <div className="bg-indigo-600 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold text-lg shadow-sm shadow-indigo-200">C</div>
        <span className="font-bold text-xl text-gray-800 tracking-tight">ClientFlow</span>
      </div>
      ...
      <div className="p-4 m-4 bg-gray-50 rounded-xl border border-gray-100">
        ...
        <button
          ...
          className="flex items-center gap-2 w-full px-3 py-2 text-sm font-medium text-gray-500 rounded-lg hover:text-red-600 hover:bg-red-50 transition-colors"
        >
