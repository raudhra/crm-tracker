    ...
    <div className="pb-8">
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="show">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm lg:col-span-2">
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link to="/customers" className="text-indigo-600 text-sm font-medium hover:text-indigo-700 transition-colors">View all</Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col">
            ...
            <div className="mt-4 pt-4 border-t border-gray-50 text-center">
              <Link to="/tasks" className="text-indigo-600 text-sm font-medium hover:text-indigo-700 flex items-center justify-center gap-1 transition-colors">
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link to="/tasks" className="text-indigo-600 text-sm font-medium hover:text-indigo-700 transition-colors">View all</Link>
            </div>
