...
function Messages() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          {loading ? (
            ...
            customers.map(c => (
              <div 
                ...
                className={`p-4 border-b border-gray-100 cursor-pointer transition flex items-center gap-3 ${selectedCustomer?.id === c.id ? 'bg-indigo-50/50 border-l-4 border-l-indigo-600' : 'hover:bg-gray-50 border-l-4 border-l-transparent'}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-0.5">
                    ...
                    {/* Timestamp could go here if we had last_activity */}
                  </div>
      ...
      <div className="w-2/3 flex flex-col bg-white">
        {!selectedCustomer ? (
          <div className="flex-1 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-lg font-medium text-gray-500">Select a customer</p>
            ...
            <div className="p-4 border-b border-gray-100 bg-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">{selectedCustomer.company || 'No Company'}</p>
                </div>
              </div>
            </div>
              ...
              {messages.length === 0 ? (
                ...
                messages.map((msg) => (
                  <div key={msg.id} className="flex flex-col max-w-[85%] self-start">
                    ...
                    <div className="bg-white border border-gray-100 shadow-sm p-3.5 rounded-2xl rounded-tl-sm text-sm text-gray-800 flex flex-col gap-2">
            ...
            <div className="p-4 bg-white border-t border-gray-100">
              <form onSubmit={handleSendMessage} className="flex gap-3">
                <select 
                  ...
                  className="w-28 border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-50/50"
                >
                ...
                <input
                  ...
                  className="flex-1 border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-50/50"
                />
                <button 
                  type="submit"
